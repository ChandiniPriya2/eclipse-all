<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" import="ai.jobiak.model.Product" import="java.util.ArrayList"%>
<!DOCTYPE html>
<html>
<head>
...
<% 
 ArrayList<Product> itemsList=null;
  ...
  for(int i=0;i<itemsList.size();i++){
   out.println("<a href='cart2.jsp?item="+itemsList.get(i).getProductId()+"'>Add Items :"+itemsList.get(i).getProductId()+"</a></br>");
  } 
